...
module
    ...
    .factory('FileUploader', ['fileUploaderOptions', '$rootScope', '$http', '$window', '$compile',
        function(fileUploaderOptions, $rootScope, $http, $window, $compile) {
             ...
             */
            FileUploader.prototype.deleteItem = function (fileName, severPath) {
            };

            /**
             * Preview Item on the server
             */
            FileUploader.prototype.previewItem = function (fileName, severPath) {
            };
            ...
            FileUploader.prototype._xhrTransport = function(item) {
                ...
                var that = this;
                var dataAlongWithFile = $('form').serializeArray();
                
                angular.forEach(dataAlongWithFile, function (obj) {
                    form.append(obj.name, obj.value);   
                });

                angular.extend(item.formData, dataAlongWithFile);
            ...
            /**
             * Delete uploaded of FileItem
             */
            FileItem.prototype.delete = function () {
                this.uploader.deleteItem(this);
            };
            /**
             * Preview uploaded of FileItem
             */
            FileItem.prototype.preview = function () {
                this.uploader.previewItem(this);
            };
            /**
             * Removes a FileItem
             */
