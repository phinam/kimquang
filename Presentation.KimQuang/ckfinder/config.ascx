...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        BaseDir = HttpContext.Current.Server.MapPath("~/Content/UploadFiles/");
        ...
        type = ResourceType.Add("Office");
        type.Url = BaseUrl + "Office/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "Office/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "xls", "xlsx", "doc", "docx", "pdf", "png", "ppt", "pptx", };
        type.DeniedExtensions = new string[] { };
        
        type = ResourceType.Add("Import");
        type.Url = BaseUrl + "Import/";
        type.Dir = BaseDir == "" ? "" : BaseDir + "Import/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "xls", "xlsx" };
        type.DeniedExtensions = new string[] { };
	}
